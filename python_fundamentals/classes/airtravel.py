...
class Flight:
    '''A flight with a particular passeger aircraft.'''
...
def make_flight():
    ...
    f.allocate_seat('15F', 'Bjarne Strosst')
    f.allocate_seat('15E', 'Anders Hejliksd')
    f.allocate_seat('1C', 'John Biulok')
    f.allocate_seat('1D', 'Alice Hickey')
    return f
